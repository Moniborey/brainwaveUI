...
export default function Header() {
  ...
  return (
    <div className={`fixed left-0 w-full top-0 z-50 border-b ${openNavigation ? 'bg-n-8' : 'bg-n-8/90 backdrop-blur-sm'} border-n-6 lg:bg-n-8/90`}>
